...
## Corpus Check
- 58 files · ~674,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 824 nodes · 1491 edges · 82 communities (58 shown, 24 thin omitted)
...
- `number()` --calls--> `isPostfixIeHack()`  [EXTRACTED]
  public/formacoes/assets/paged.polyfill.js → public/formacoes/assets/paged.polyfill.js  _Bridges community 27 → community 4_
...
Cohesion: 0.02
Nodes (21): NOTE: The order of the mappings is NOT guaranteed., TODO: should consume block content as Raw?, TODO: fall back to mutation observer?, TODO: not sure we should support this hack, TODO: check value is an ident, TODO: produce a node with Delim node type, NOTE: Don't check more than a first argument is an ident, rest checks are for le, TODO: this isn't working right, needs to check what is in the prelude (+13 more)

### Community 1 - "Layout"
Cohesion: 0.06
Nodes (27): breakInsideAvoidParentNode(), BreakToken, cloneNode(), elementAfter(), findElement(), findRef(), Footnotes, getBoundingClientRect() (+19 more)

### Community 2 - "AtPage"
Cohesion: 0.08
Nodes (6): append(), AtPage, createItem(), CSSValueToString(), validate(), walk()

### Community 3 - "Page"
Cohesion: 0.06
Nodes (10): CodeExample(), ConnectionsDiagram(), FILTER_CATEGORIES, type_colors, Chunker, dump(), forEachToken(), Page (+2 more)

### Community 4 - ".push"
Cohesion: 0.06
Nodes (16): collectWarning(), computeSourceURL(), Counters, isAbsolute(), join(), normalize(), number(), PageCounterIncrement (+8 more)

### Community 5 - "dependencies"
Cohesion: 0.05
Nodes (43): @emotion/react, @emotion/styled, eslint, eslint-config-next, @eslint/eslintrc, framer-motion, googleapis, lucide-react (+35 more)

### Community 6 - ".replace"
Cohesion: 0.07
Nodes (19): attr(), calc(), child(), cleanPseudoContent(), consumeFunction(), customIdent(), defer(), eqStr() (+11 more)
...
### Community 8 - "Sheet"
Cohesion: 0.10
Nodes (6): ContentParser, Handler, Hook, invokeForType(), Lists, Sheet

### Community 9 - "peek"
Cohesion: 0.13
Nodes (20): charCode(), customPropertyName(), idSelector(), maybeMultiplied(), maybeToken(), parse$2(), peek(), readGroup() (+12 more)

### Community 10 - "Breaks"
Cohesion: 0.10
Nodes (14): Breaks, CommentsFilter, displayedElementAfter(), displayedElementBefore(), elementBefore(), filterTree(), getNodeWithNamedPage(), isAllWhitespace() (+6 more)

### Community 11 - "Queue"
Cohesion: 0.12
Nodes (10): Queue, requireEs6Symbol(), requireIsArguments(), requireIsFunction(), requireIsImplemented(), requireIsString(), requireIsSymbol(), requirePolyfill() (+2 more)
...
### Community 35 - "processStructure"
Cohesion: 0.50
Nodes (4): createNodeStructureChecker(), isValidLocation(), isValidNumber(), processStructure()
...
## Knowledge Gaps
- **71 isolated node(s):** `metadata`, `metadata`, `categoryIcons`, `metadata`, `metadata` (+66 more)
...
- **Why does `AtPage` connect `AtPage` to `paged.polyfill.js`, `Page`?**
